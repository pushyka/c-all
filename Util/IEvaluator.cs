...
namespace chess.Util
{
    interface IEvaluator
    {
        ...
        /// <returns></returns>
        bool validateMove(FormedMove move, Square[,] board, char cur_turn, ref string moveType);
        ...
        /// <returns></returns>
        bool isKingInCheck(Square[,] board, char player, ref List<Tuple<int, int>> attackerPositions);
    }
}
